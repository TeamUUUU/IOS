...
//        boards.apiClient.configuration
        ...
        boards.boardsGet(withUserId: user, completionHandler: { (boards, error) in
            ...
            self.boards = (boards as! Array<OAIBoard>)
        }
        )
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        cell.titleText.text = boards![indexPath.row].title
        cell.descriptionText.text = boards![indexPath.row]._description
